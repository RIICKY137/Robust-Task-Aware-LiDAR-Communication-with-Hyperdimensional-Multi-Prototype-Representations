#!/usr/bin/env python3
"""128 B k=16 remake on LidarDataFrames (author place labels).

Does not overwrite sim_indoor or semantic2d JSONL. Four classes; no cluttered_area.
test_ood is a stratified i.i.d. holdout (CSV has no building id).
"""
...
def main() -> None:
    ...
    out = raw_dir() / "k16_lidardataframes.jsonl"
    if out.exists():
        out.unlink()
    for seed in SEEDS:
